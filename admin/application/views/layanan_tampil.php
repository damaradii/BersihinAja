        ...
        <table class="table table-bordered" id="tabelku">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo base_url("layanan/edit/".$v["Id_Services"]) ?>"  class="btn btn-warning">Edit</a>
                <a href="<?php echo base_url("layanan/hapus/".$v["Id_Services"]) ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
            <?php endforeach ?>
          </tbody>
